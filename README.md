...
- ⌘ **快捷键说明页** — 按 `Tab` 在固定正文区域查看通用、正常模式和多选模式的完整快捷键,按 `Esc` 返回
...
前往 [Releases](https://github.com/akira82-ai/echo-app/releases),下载当前版本 `2.4.0` 的 `Echo.dmg`。打开 DMG 后,将 Echo 拖进「应用程序」即可。
