...
- 🎯 **选中反馈更连贯** — 键盘移动时高亮背景平滑跟随,不打断连续选择
- 🧩 **文本多选粘贴** — 按住 `⌘` 点击或按 `⌘↵` 选择最多 5 条文本,松开后按 `↵` 按选择顺序用换行合并粘贴
...
前往 [Releases](https://github.com/akira82-ai/echo-app/releases),下载当前版本 `2.3.0` 的 `Echo.dmg`。打开 DMG 后,将 Echo 拖进「应用程序」即可。
...
③ 选一条(1–5 / 6+搜索 / 方向键) →  自动粘到当前光标
   ⌥↵ 可改为纯文本粘贴,默认保留原格式
④ 按住 ⌘ 点击或按 ⌘↵ 选择最多 5 条文本 → 松开 ⌘ 后按 ↵ 按顺序合并粘贴
```
