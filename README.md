...
- 🧩 **文本多选粘贴** — 按住 `⌘` 点击或按 `⌘↵` 选择最多 5 条文本,彩色编号标记顺序,松开后按 `↵` 按选择顺序用换行合并粘贴
...
前往 [Releases](https://github.com/akira82-ai/echo-app/releases),下载当前版本 `2.3.2` 的 `Echo.dmg`。打开 DMG 后,将 Echo 拖进「应用程序」即可。
